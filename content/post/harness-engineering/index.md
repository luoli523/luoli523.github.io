...
![三代范式演进：Prompt ⊂ Context ⊂ Harness](paradigm-evolution.webp)
...
![驾驶类比：Prompt 是指令，Context 是地图，Harness 是整辆车](car-analogy.webp)
...
![串联衰减：单步 95% 成功率在 20 步后衰减至 36%](serial-decay.webp)
...
![Anthropic 架构演进：双 Agent → 三 Agent（Planner-Generator-Evaluator）](anthropic-architecture.webp)
...
![Voxel 的工具减法：移除 80% 工具后效果反而全面提升](tool-subtraction.webp)
